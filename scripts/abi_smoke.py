...
def main() -> int:
    ...
    for needle in ["额度面板", "全部", "OpenCode Go", "Deepseek API", "智谱 CodingPlan", "sk******ef", "sk******56", "codex", "claude"]:
        assert needle in html, f"dashboard missing {needle!r}"
    print("dashboard OK: contains 全部/OpenCode Go/Deepseek API/智谱 CodingPlan/masked keys/type tags")

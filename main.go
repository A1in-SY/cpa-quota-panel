	...
	return registration{
		...
		Metadata: pluginapi.Metadata{
			...
			ConfigFields: []pluginapi.ConfigField{
				...
				{Name: "quota-sources", Type: pluginapi.ConfigFieldTypeArray, Description: "白名单厂商模板：JSON 数组，每项 {id, name, match-base-urls[], quota-url, auth, kind}。kind: percent-windows | balance | grants | coding-plan | zhipu-plan | cline-plan。不填则默认 opencode/deepseek/minimax/智谱/Cline Pass 五家。"},
			},
		},
